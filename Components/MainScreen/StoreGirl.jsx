...
function StoreGirl(props) {
  return (
    <div className="flex rounded-3xl shadow-md flex-col bg-secondary-2 w-full text-myWhite-2">
      <div className="flex-center flex-col">
        <h1 className="text-h4 font-IRYekanBold rtl p-1">به ما اعتماد کنید</h1>
